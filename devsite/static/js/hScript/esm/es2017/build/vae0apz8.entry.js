    ...
    render() {
        return (h("div", { id: "theTabContainer", class: "c-tabs" },
            ...
            h("div", { class: "c-button-container" }, this.tabs.map((tab, i) => {
                if (tab.open) {
                    return (h("button", { disabled: tab.disabled, class: `c-button c-button--showMore`, onClick: () => this.expand(i), onMouseOut: () => this.removeFocus(i) }, "Show More"));
                }
            }))));
    }
